...
export default function TopNavbar() {
  return (
    <div className='w-full '>
      <div className='w-full h-auto flex flex-col items-center shadow-md bg-[#70d6bb] '>
        <div className='w-full flex justify-center bg-[#6dcfb5] '>
          <div className='w-full flex pt-2 rounded-t-[10px] justify-between items-center max-w-[1400px]  px-4'>
            <div>
              <Link href="/">
        ...
        <div className='w-full flex items-center justify-between gap-3 px-4 pt-2 pb-3 max-w-[1400px] '>
