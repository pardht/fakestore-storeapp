...
export default function Carousel({ products }: CarouselProps) {
    ...
    return (
            <div className="w-[600px] overflow-clip rounded-[10px] brightness-[0.95] bg-white">
                                        ...
                                        <div className=' h-full flex gap-5'>
                                            <div className='flex items-center justify-center'>
                                                <Image src={product.image} alt='ProductImage' width={100} height={100} priority={true}
                                                    className='w-20 md:w-[300px] md:max-h-[15rem] mx-auto scale-100 transition-all' />
                                            </div>
                                            <div className='w-full h-full flex  rounded-[10px]'>
                                                <div className='w-full flex flex-col md:gap-2'>
                                                    ...
                                                    <p className='max-w-[500px] text-sm md:text-base font-[350] transition-all line-clamp-4  md:tracking-wide '>
                                                        {product.description}
                                                    </p>
                                                </div>
                                            </div>
