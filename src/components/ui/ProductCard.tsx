...
export default function ProductCard({ product }: ProductCardProps) {
    return (
        <div>
            <Link href={`product/${product.id}`} className='bg-black'>
                <div className='w-full h-full max-h-[23rem] pb-[7rem] relative bg-white rounded-[10px] shadow-lg group transition-all brightness-[0.95] hover:shadow-xl'>
